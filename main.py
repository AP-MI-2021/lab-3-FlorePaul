def show_menu():
    ...
    print("3.Determinare cea mai lunga subsecventa cu proprietatea ca toate numerele sale sunt formate din cifre prime")
    print("4.Determinare cea mai lunga subsecventa cu proprietatea ca toate numerele sale sunt palindroame")
    print("x.Exit")
...
def get_longest_prime_digits(lst):
    ...
    for st in range(n):
        for dr in range(st, n):
            ...
            for num in lst[st:dr + 1]:
                if not has_all_prime_digits(num):
